...
public class EmbeddingStoreService {
    ...
    public EmbeddingStoreService(OpenAiApi openAiApi) {
        this.openAiApi = openAiApi;
    }

    public Embedding getEmbedding(StoreDocument reviewDocument) {
    ...
    public List<Embedding> getEmbeddings(List<StoreDocument> storeDocuments) {
        ...
        EmbeddingResponse embeddingResponse = openAiEmbeddingModel
                .embedForResponse(storeDocuments.stream().map(StoreDocument::toString).toList());
